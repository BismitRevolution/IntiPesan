		...
		<div class="table-responsive">
			<form method="POST" action="{{ route('admin.events.store') }}" enctype="multipart/form-data">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<textarea id="description" name="description" class="form-control" type="text" placeholder="Description" required></textarea>
					</div>
				</div>
				<div class="form-group row">
					<label for="quota" class="col-sm-2 col-form-label">Quota</label>
					<div class="col-sm-10">
						<input id="quota" name="quota" class="form-control" type="number" placeholder="Quota" required/>
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-sm-5">
						<input id="start_time" name="start_time" class="form-control" type="time" required/>
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-sm-5">
						<input id="end_time" name="end_time" class="form-control" type="time" required/>
					</div>
				</div>
				<div class="form-group row">
